...
require(__DIR__ . "\\pimodule.php");
    ...
    class SymconSchwellwertTimerV2 extends PISymconModule {
        ...
        public function RegisterProperties () {
            ...
            $this->RegisterPropertyInteger("Sensor1Profile", 7);
            $this->RegisterPropertyInteger("Sensor2Profile", 7);
            $this->RegisterPropertyInteger("Sensor3Profile", 7);
        ...
        protected function setNeededProfiles () {
            return array("Lux", "Temperature_F", "Temperature_C", "Wattage", "Windspeed", "Prozent");
        }
        ...
        protected function giveTresholdProfile ($tresholdVar, $tresholdVal, $source) {
            ...
            if ($tresholdVal == 6) {
                ...
                if ($this->getVarType($tresholdVar) == $this->varTypeByName("int") && $this->getVarProfile($tresholdVar) != $this->prefix . ".Prozent") {

                    $this->addProfile($tresholdVar, $this->prefix . ".Prozent");
                    $this->setIcon($tresholdVar, "Intensity");
